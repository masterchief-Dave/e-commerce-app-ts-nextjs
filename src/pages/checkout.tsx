    ...
    <div>
      ...
      <div className='grid grid-cols-12 font-inter'>
        ...
        <div className='col-start-8 col-end-13 grid grid-cols-12 bg-[#f7f9fa] py-24'>
          <div className='col-start-4 col-end-10 space-y-12 py-12'>
            ...
            <div className='space-y-8 divide-y'> 
              <div className='space-y-8'>
                <div className='grid grid-cols-12'>
                  <h4 className='col-start-1 col-end-8'>Original price</h4>
                  <p className='col-start-8 col-end-13'>$2000</p>
                </div>

                <div className='grid grid-cols-12'>
                  <h4 className='col-start-1 col-end-8'>Discounts</h4>
                  <p className='col-start-8 col-end-13'>$200</p>
                </div>
              </div>
