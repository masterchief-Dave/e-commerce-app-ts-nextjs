        ...
        <section className="col-start-1 col-end-8 py-32 px-24 space-y-12">
          ...
          <div className="border rounded-xl p-6 divide-y">
            <div className="space-y-4 py-6">
              <h3 className=" text-primary-grey-300 font-medium">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/"
              className="h-[4rem] flex items-center justify-center  font-medium bg-blue-500 rounded-md px-8 py-2 text-white"
            >
              Continue Shopping
            </Link>
          </div>
