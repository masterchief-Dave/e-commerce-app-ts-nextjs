...
export function UserAccountDropdown() {
  ...
  const links = [
    ...
    { id: 3, name: 'Privacy Policy', link: '/legal/privacy-policy' },
  ...
  return (
    <Menu as='div' className='text-[1.4rem] z-[99]'>
      <Menu.Button className='relative block w-16 h-16'>
        <Image src={session?.data?.user?.image!} alt='user logo' width={1000} height={1000} className='h-16 w-16 rounded-full' />
      </Menu.Button>
