...
export const Footer = (props: Props) => {
  ...
  return (
    <>
            ...
            <div className='space-y-8'>
              ...
              <ul className='grid grid-cols-2 items-center gap-4 text-[1.6rem] font-normal text-primary-blue-700 lg:block lg:gap-0 lg:space-y-6 lg:text-[1.3rem]'>
                ...
                <div className='space-y-8 flex flex-col items-start'>
                  <h4 className={styles.footerHeader}>Subscribe to our Newsletter</h4>
                  <form>
                    <div className='flex w-full items-center gap-x-4 text-[1.6rem] lg:w-[45rem] lg:text-[1.2rem]'>
                      ...
                      <Button
                        ...
                        className='h-full w-fit rounded-md bg-primary-yellow-300 px-4 py-4 text-[1.6rem] font-normal uppercase text-white lg:px-6 lg:py-4 lg:text-[1.6rem]'
                      >
                        Subscribe
                      </Button>
                    </div>
      ...
      <AlertDialogComp
        description="I am hard at work bringing you a new feature. Stay tuned for updates!" headerText="Exciting Feature Coming Soon!" open={open.state && open.name === 'email-subscribe-modal'} onClose={() => handleClose('email-subscribe-modal')} />
    </>
  )
}
