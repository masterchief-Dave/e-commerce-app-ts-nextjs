...
export const Footer = (props: Props) => {
  const styles = {
    ...
    footerHeader: `text-base lg:text-[1.8rem] font-semibold text-white font-matter`,
  ...
  return (
    <footer className='mx-auto grid w-full grid-cols-12'>
      <div className='col-span-full  grid-cols-12 border-b bg-primary-blue-400 lg:grid'>
        <section className='col-start-2 col-end-12 flex flex-col items-center justify-between gap-4 p-12 lg:flex-row'>
          <div className='order-2 w-full space-y-8'>
            ...
            <form>
              <div className='flex w-full items-center gap-2 font-inter text-base lg:w-[40rem] lg:text-[1.2rem]'>
                <input
                  type='text'
                  placeholder='email'
                  className='subscribe-btn h-full w-[90%] rounded-md border py-4 px-2 lg:py-4 lg:px-[1rem]'
                />
                <button className='h-full w-fit rounded-md bg-primary-yellow-200 px-4 py-4 font-inter text-base font-bold uppercase text-white lg:px-6 lg:py-4 lg:text-[1.1rem]'>
                  Subscribe
                </button>
              </div>
            </form>
      ...
      <div className='col-span-full grid grid-cols-12 bg-primary-blue-100 py-8'>
        <section className='col-start-2 col-end-12 mb-10 flex flex-col gap-8 font-inter lg:grid  lg:grid-cols-3'>
          <div className='space-y-8'>
            ...
            <div className='flex items-center gap-6'>
              ...
              <div className='text-base lg:text-[1.3rem]'>
                <p className='font-inter text-primary-blue-700'>
                  {' '}
            ...
            <div className='flex items-center gap-6'>
              ...
              <div className='text-base lg:text-[1.3rem]'>
                <p className='font-inter text-white'>Address :</p>
          ...
          <div className='space-y-8'>
            ...
            <ul className='grid grid-cols-2 items-center gap-4 font-inter text-base font-normal text-primary-blue-700 lg:block lg:gap-0 lg:space-y-6 lg:text-[1.3rem]'>
              <li>
      ...
      <section className='col-span-full col-start-1 border-t bg-primary-blue-300 font-inter text-[1.3rem] font-medium text-white'>
        <div className='grid grid-cols-12'>
          <div className='col-start-2 col-end-12 flex flex-col items-center justify-between lg:flex-row'>
            <p className='font-inter text-[1.2rem] font-bold'>
